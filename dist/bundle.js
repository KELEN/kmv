...
/***/ function(module, exports, __webpack_require__) {
	...
	var watcher_1 = __webpack_require__(7);
	function Kmv(opts) {
	    ...
	    setTimeout(function () {
	        render_1.renderInit(that.watchers, that.$data, opts.data);
	    }, 0);
	    return this;
	}
	window.Kmv = Kmv;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.renderInit = function (watcher, data, observeData) {
	        ...
	        switch (node.renderType) {
	            ...
	            case constant_1.RenderType.INPUT:
	                ...
	                node.oninput = function () {
	                    observeData[kModel_1] = this.value;
	                };
	                break;
...
/***/ function(module, exports) {
	...
	exports.ArrayMethod = ['push', 'pop', 'slice', 'splice', 'shift', 'unshift', 'soft', 'reverse'];
	var RenderType;
	(function (RenderType) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var constant_1 = __webpack_require__(3);
	var validator_1 = __webpack_require__(8);
	        ...
	        for (var i = 0; i < childNodes.length; i++) {
	            ...
	            switch (child.nodeType) {
	                ...
	                case constant_1.NodeType.ELEMENT:
	                    ...
	                    else if (constant_1.RegexpStr.inputElement.test(child.tagName)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VDOM = (function () {
	    ...
	    VDOM.prototype.transDOM = function (data) {
	...
	var ForDOM = (function () {
	    function ForDOM(node) {
	        ...
	        var template = node.firstChild.nodeValue;
	        this.vdom = {
	            tagName: node.tagName,
	            forString: forString,
	        ...
	        if (node.children) {
	            for (var i = 0; i < node.children.length; i++) {
	                var virtualDOM = new VDOM(node.children[i]);
	    ...
	    ForDOM.prototype.renderInit = function (data) {
